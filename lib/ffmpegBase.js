...
var FfmpegBase = (function () {
   ...
   *
   * @param value {number|string} Duration may be a number in seconds, or in hh:mm:ss[.xxx] form.
   * @returns {FfmpegBase}
   */
   ...
   */
		...
		key: 'audioFilter',
		value: function audioFilter(value) {
			(0, _utils.setOrClear)(this._options, '-filter:a', value);
			return this;
		}
	}, {
		key: 'input',
